    ...
    return (
      <div className='dt w-100 h-100'>
        <div className='w4 w5-l dtc v-top br b--light-gray'>
          <div className='w4 w5-l overflow-hidden'>
            <div className='w4 w5-l fixed'>
              <div className='pl3 pt4 pt5-l pr3 pb3 bg-blue bg-animate contain bg-top' style={group ? { backgroundImage: `url(${group.headerImage})`, backgroundColor: group.color, backgroundBlendMode: 'soft-light' } : {}}>
                <h4 className='f5 f4-l white-90 helvetica ph2 overflow-hidden'>{group ? group.displayName : <Skeleton count='2' />}</h4>
              ...
              <nav className='flex flex-wrap pt3 bt b--light-gray pl2 pr2 mt2'>
                <div className='w-100 f5 black-80 helvetica pb2 dib'>
                  <span className='ph2 helvetica'>
                    Experts
                  </span>
                </div>
                {group ? group.members.edges.map(memberEdge => {
                  ...
                  return (
                    <div className='w-auto w-100-l dib pl1 pr1 center'>
